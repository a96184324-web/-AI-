...
def handle_image(event):
  with ApiClient(configuration) as api_client:
    ...
    try:
      ...
      # 究極の予想プロンプト（騎手・厩舎の差別化 ＆ 買い目自動選定 ＆ 捏造防止）
      prompt = (
          ...
          '【買い目の自動選定ルール】\n'
          'レースの堅実度に応じて、最も回収率・的中率のバランスが良い券種・買い方を自動選定して出力すること。\n'
          '・堅実度A（軸信頼・本命戦）➔ 【単勝・馬単・3連単】など点数を絞った高回収狙い\n'
          '・堅実度B（標準・相手絞り）➔ 【馬連・馬単】および【3連複フォーメーション】\n'
          '・堅実度C（混戦・大荒れ必至）➔ 【ワイド】および高配当を狙える【3連複手広め流し・BOX】\n\n'
          '【出力フォーマット】\n'
          ...
          '（理由を1文程度で。タイム・着差、斤量・騎手や厩舎に関する事実も交えて）\n\n'
          ...
          '（理由を1文程度で）\n\n'
          '■ 3. おすすめの買い目 【AI選定：堅実度〇に応じた最適な券種】\n'
          '（※堅実度A〜Cのルールに基づいて選定した券種・買い目を分かりやすく記載）\n\n'
          '※馬券購入は自己責任でお願いします'
      )
